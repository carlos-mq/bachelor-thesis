...
**Note**: The following documentation is an excerpt of the Appendix "Using the Implementation", at the end of the thesis.
...
The source code comes fully documented; it can be generated by running
```
cabal haddock
```
